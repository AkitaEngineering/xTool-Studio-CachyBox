...
set gpu_flags ""; set add_flags ""; set g_type "generic"; set c_file "containerfile.amd"; set qidi_force_software_rendering 1
switch $g_choice
    case 1; set gpu_flags "--nvidia"; set g_type "nvidia"; set c_file "containerfile.nvidia"; set qidi_force_software_rendering 0
    case 2; set add_flags "--device /dev/dri:/dev/dri"; set g_type "amd"; set c_file "containerfile.amd"; set qidi_force_software_rendering 0
    case 3; set add_flags "--device /dev/dri:/dev/dri"; set g_type "intel"; set c_file "containerfile.intel"; set qidi_force_software_rendering 0
end
